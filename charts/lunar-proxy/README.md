...
```bash
helm install lunar-proxy lunar/lunar-proxy --version 0.7.1 --set tenantName=<organization-name> --set lunarAPIKey=<api-key>
```
...
```bash
helm install lunar-proxy lunar/lunar-proxy --version 0.7.1 -f ./values-override.yaml
```
