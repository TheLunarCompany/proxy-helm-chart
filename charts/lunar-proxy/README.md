...
```bash
helm install lunar-proxy lunar/lunar-proxy --version 0.1.7 --set tenantName=<organization-name> --set lunarAPIKey=<api-key>
```
...
```bash
helm install lunar-proxy lunar/lunar-proxy --version 0.1.7 -f ./values-override.yaml
```
