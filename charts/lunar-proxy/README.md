...
```bash
helm install lunar-proxy lunar/lunar-proxy --version v1.1.2 --set tenantName=<organization-name> --set lunarAPIKey=<api-key>
```
...
```bash
helm install lunar-proxy lunar/lunar-proxy --version v1.1.2 -f ./values-override.yaml
```
