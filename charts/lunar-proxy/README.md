...
```bash
helm install lunar-proxy lunar/lunar-proxy --version 1.1.16 --set tenantName=<organization-name> --set lunarAPIKey=<api-key>
```
...
```bash
helm install lunar-proxy lunar/lunar-proxy --version 1.1.16 -f ./values-override.yaml
```
