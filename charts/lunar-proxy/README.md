...
```bash
helm install lunar-proxy lunar/lunar-proxy --version 0.0.2 --set tenantName=<organization-name> --set lunarAPIKey=<api-key>
```
...
```bash
helm install lunar-proxy lunar/lunar-proxy --version 0.0.2 -f ./values-override.yaml
```
